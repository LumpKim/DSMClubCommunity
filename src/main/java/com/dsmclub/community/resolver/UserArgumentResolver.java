package com.dsmclub.community.resolver;

import com.dsmclub.community.annotation.SocialUser;
    ...
    private User getUser(User user, HttpSession session) {
        if (user == null) {
            try {
                ...
                User convertUser =
                        convertUser(authentication, getAuthorizedClientRegistrationId(), map);
