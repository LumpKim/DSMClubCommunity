...
import com.dsmclub.community.oauth.ClientResources;
import com.dsmclub.community.domain.enums.SocialType;
import com.dsmclub.community.oauth.ClientResources;
import com.dsmclub.community.oauth.UserTokenService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private Filter oauth2Filter(ClientResources client, String path, SocialType socialType) {
        ...
        filter.setAuthenticationSuccessHandler((request, response, exception) -> response.sendRedirect("/error"));
        return filter;
    }
